...
<main class="custom-frontend-main" id="main">
	<div class="custom-frontend-content" style="text-align:center;padding:4rem 1.5rem;">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" style="display:inline-block;padding:0.5rem 1.25rem;background:#3993d5;color:#fff;text-decoration:none;border-radius:0.5rem;font-weight:600;"><?php esc_html_e( 'Back to home', 'directory' ); ?></a>
	</div>
</main>
<?php
get_footer( 'custom' );
