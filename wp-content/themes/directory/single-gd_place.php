				...
				<?php if ( function_exists( 'do_shortcode' ) ) : ?>
					<section class="cf-single-place-section cf-single-place-map" aria-labelledby="cf-map-heading">
						...
						<div class="cf-single-place-map-container">
							<?php
							// Single-listing map, heavily zoomed out for broad regional context.
							echo do_shortcode( '[gd_map width="100%" height="400px" maptype="ROADMAP" zoom="8" map_type="post" map_directions="1"]' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
							?>
						</div>
					</section>
				<?php endif; ?>
