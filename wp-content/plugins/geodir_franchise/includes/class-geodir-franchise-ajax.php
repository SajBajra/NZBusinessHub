<?php
/**
 * Franchise Manager AJAX class.
 *
 * Franchise Manager AJAX Event Handler.
 *
 * @since 2.0.0
...
/**
 * GeoDir_Franchise_AJAX class.
 */
class GeoDir_Franchise_AJAX {
	...
	public static function add_ajax_events() {
		...
		foreach ( $ajax_events as $ajax_event => $nopriv ) {
			...
			if ( $nopriv ) {
				...
				add_action( 'geodir_franchise_ajax_' . $ajax_event, array( __CLASS__, $ajax_event ) );
			}
		}
	}
}