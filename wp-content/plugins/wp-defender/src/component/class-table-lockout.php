...
class Table_Lockout extends Component {
	...
	private function get_types(): array {
		return array(
			...
			Lockout_Log::ERROR_404_XSS                   => esc_html__( 'XSS attempt', 'wpdef' ),
			Lockout_Log::LOCKOUT_404_XSS                 => esc_html__( 'XSS lockout', 'wpdef' ),
			Lockout_Log::ERROR_404_NON_EXISTENT_THEME    => esc_html__( 'Attempt to access non-installed theme', 'wpdef' ),
			Lockout_Log::LOCKOUT_404_NON_EXISTENT_THEME  => esc_html__( 'Non-installed theme lockout', 'wpdef' ),
			Lockout_Log::ERROR_404_NON_EXISTENT_PLUGIN   => esc_html__( 'Attempt to access non-installed plugin', 'wpdef' ),
			Lockout_Log::LOCKOUT_404_NON_EXISTENT_PLUGIN => esc_html__( 'Non-installed plugin lockout', 'wpdef' ),
		);
	}
