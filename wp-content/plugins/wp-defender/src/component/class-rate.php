...
class Rate extends Component {
	...
	private static function was_rate_request(): bool {
		if ( true === get_site_option( self::SLUG_FOR_BUTTON_RATE, (bool) apply_filters( 'wd_display_rating', false ) ) ) {
			return true;
		}
		if ( true === get_site_option( self::SLUG_FOR_BUTTON_THANKS, (bool) apply_filters( 'wd_dismiss_rating', false ) ) ) {
			return true;
		}
