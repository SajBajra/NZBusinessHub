	...
	<div class="wds-separator-top">
		...
		$this->render_view(
			...
			array(
				...
				'item_label'       => esc_html__( 'OpenGraph & X Cards', 'wds' ),
				'item_description' => esc_html__( 'Enhance how your posts and pages look when shared on X and Facebook by adding extra meta tags to your page output.', 'wds' ),
				'checked'          => true,
				'attributes'       => array(
					'data-processing' => esc_attr__( 'Activating OpenGraph & X Cards', 'wds' ),
				),
			)
		);
		?>
