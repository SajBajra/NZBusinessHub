...
<section id="<?php echo esc_attr( \SmartCrawl\Admin\Settings\Dashboard::BOX_SOCIAL ); ?>" class="sui-box wds-dashboard-widget">
	...
	<div class="sui-box-body">
		<p><?php esc_html_e( 'Control and optimize how your website appears when shared on social platforms like Facebook and X.', 'wds' ); ?></p>
		...
		<?php if ( $social_enabled ) : ?>
			...
			<div class="wds-separator-top wds-draw-left-padded">
				<small><strong><?php esc_html_e( 'X Cards', 'wds' ); ?></strong></small>
				<?php if ( ! $twitter_card_enabled ) : ?>
					<p>
						<small><?php esc_attr_e( 'With X Cards, you can attach rich photos, videos and media experiences to Posts, helping to drive traffic to your website.', 'wds' ); ?></small>
					</p>
					<button
						type="button"
						data-option-id="<?php echo esc_attr( $social_option_name ); ?>"
