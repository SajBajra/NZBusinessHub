	...
	private function get_plugin_modules() {
		...
		$all_plugin_modules = array(
			...
			'instant_indexing' => $this->plugin_module_args(
				__( 'Instant Indexing', 'wds' ),
				__( 'Notify search engines like Bing and Yandex via the IndexNow API whenever pages are added and updated. You can also submit URLs manually.', 'wds' ),
				'instant_indexing',
				false,
				null,
