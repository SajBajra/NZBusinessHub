 ...
 *
 * You can overide this template by copying it to your-theme-folder/geodir-booking/ruleset-editor.php
 *
 * @since 1.0.0
 */
	...
	<template v-for="listing in listings" :key="listing.ID">
		<div class="gdbc-ruleset-editor" v-if="listing.ID === listing_id">
			...
			<div class="gdbc-ruleset-editor__header d-flex align-items-center mb-4">
				...
				<a href="#" v-if="!listing.editing_title" @click.prevent="listing.editing_title = true" class="gdbc-ruleset-editor-header__edit-title">
			...
			<div class="accordion mb-4" id="gdbc-ruleset-editor-accordion">
				...
				<div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-nightly-price" aria-expanded="true" aria-controls="gdbc-ruleset-editor-nightly-price">
							<?php esc_html_e( 'Nightly Price', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-nightly-price" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
							<div class="form-group">
								<label for="gdbc-ruleset-nightly-price"><?php esc_html_e( 'Nightly price', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
									...
									<div class="input-group-append" style="top: 0px; right: 0px;">
                ...
                <div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-extra-fees" aria-expanded="true" aria-controls="gdbc-ruleset-editor-extra-fees">
							<?php esc_html_e( 'Extra Fees', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-extra-fees" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
							<div class="form-group">
								<label for="gdbc-ruleset-cleaning-fee"><?php esc_html_e( 'Cleaning Fee', 'geodir-booking' ); ?> <small>(<?php esc_html_e( 'per booking', 'geodir-booking' ); ?>)</small></label>
								<div class="input-group input-group-sm">
                            ...
                            <div class="form-group">
								<label for="gdbc-ruleset-pet-fee"><?php esc_html_e( 'Pet Fee', 'geodir-booking' ); ?> <small>(<?php esc_html_e( 'per booking', 'geodir-booking' ); ?>)</small></label>
								<div class="input-group input-group-sm">
							...
							<div class="form-group">
								<label for="gdbc-ruleset-extra-guest-fee"><?php esc_html_e( 'Extra Guests Fee', 'geodir-booking' ); ?></label>
								<small class="d-block form-text mt-0 mb-2">
									<?php
										printf(
				...
				<div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-duration-discount" aria-expanded="true" aria-controls="gdbc-ruleset-editor-duration-discount">
							<?php esc_html_e( 'Length-of-stay discounts', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-duration-discount" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
							<small class="form-text text-muted mb-3"><?php esc_html_e( 'Set discounts based on weekly or monthly stays, or customize your own.', 'geodir-booking' ); ?></small>

							<div v-if="listing.ruleset.duration_discounts.length">
								<div class="gdbc-ruleset-editor-duration-discount row form-group">
				...
				<div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-last-minute-discount" aria-expanded="true" aria-controls="gdbc-ruleset-editor-last-minute-discount">
							<?php esc_html_e( 'Last-minute discounts', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-last-minute-discount" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
							<small class="form-text text-muted mb-3"><?php esc_html_e( 'Offer a discount for bookings that happen close to arrival.', 'geodir-booking' ); ?></small>

							<div v-if="listing.ruleset.last_minute_discounts.length">
								<div class="gdbc-ruleset-editor-last-minute-discount row form-group">
				...
				<div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-early-bird-discount" aria-expanded="true" aria-controls="gdbc-ruleset-editor-early-bird-discount">
							<?php esc_html_e( 'Early-bird discounts', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-early-bird-discount" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
							<small class="form-text text-muted mb-3"><?php esc_html_e( 'Offer a discount for bookings that happen well in advance.', 'geodir-booking' ); ?></small>

							<div v-if="listing.ruleset.early_bird_discounts.length">
								<div class="gdbc-ruleset-editor-early-bird-discount row form-group">
				...
				<div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-availability" aria-expanded="true" aria-controls="gdbc-ruleset-editor-availability">
							<?php esc_html_e( 'Availability', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-availability" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
							<small class="form-text text-muted mb-3"><?php esc_html_e( 'Set the minimum and maximum stay, and customize it by day if needed.', 'geodir-booking' ); ?></small>

							<div class="form-group">
								<label for="gdbc-ruleset-minimum-stay"><?php esc_html_e( 'Minimum stay', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
									...
									<div class="input-group-append" style="top: 0px; right: 0px;">
										<span class="input-group-text"><?php esc_html_e( 'Nights', 'geodir-booking' ); ?></span>
									</div>
								</div>
							</div>

							<div class="form-group">
								<label for="gdbc-ruleset-maximum-stay"><?php esc_html_e( 'Maximum stay', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
							...
							<div class="custom-control custom-checkbox form-group">
								<input type="checkbox" v-model="listing.ruleset.per_day_minimum_stay"  class="custom-control-input" id="gdbc-ruleset-per-day-minimum-stay">
								<label class="custom-control-label" for="gdbc-ruleset-per-day-minimum-stay"><?php esc_html_e( 'Customize minimum stay by check in day', 'geodir-booking' ); ?></label>
							</div>

							<div class="form-group" v-if="listing.ruleset.per_day_minimum_stay">
								<label for="gdbc-ruleset-monday-minimum-stay"><?php esc_html_e( 'Monday check in', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
							...
							<div class="form-group" v-if="listing.ruleset.per_day_minimum_stay">
								<label for="gdbc-ruleset-tuesday-minimum-stay"><?php esc_html_e( 'Tuesday check in', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
							...
							<div class="form-group" v-if="listing.ruleset.per_day_minimum_stay">
								<label for="gdbc-ruleset-wednesday-minimum-stay"><?php esc_html_e( 'Wednesday check in', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
							...
							<div class="form-group" v-if="listing.ruleset.per_day_minimum_stay">
								<label for="gdbc-ruleset-thursday-minimum-stay"><?php esc_html_e( 'Thursday check in', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
							...
							<div class="form-group" v-if="listing.ruleset.per_day_minimum_stay">
								<label for="gdbc-ruleset-friday-minimum-stay"><?php esc_html_e( 'Friday check in', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
							...
							<div class="form-group" v-if="listing.ruleset.per_day_minimum_stay">
								<label for="gdbc-ruleset-saturday-minimum-stay"><?php esc_html_e( 'Saturday check in', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
							...
							<div class="form-group" v-if="listing.ruleset.per_day_minimum_stay">
								<label for="gdbc-ruleset-sunday-minimum-stay"><?php esc_html_e( 'Sunday check in', 'geodir-booking' ); ?></label>
								<div class="input-group input-group-sm">
				...
				<div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-check-in-days" aria-expanded="true" aria-controls="gdbc-ruleset-editor-check-in-days">
							<?php esc_html_e( 'Check-in and checkout days', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-check-in-days" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
							<small class="form-text text-muted"><?php esc_html_e( "Select the days when you don't want guests to check in and check out", 'geodir-booking' ); ?></small>

							<div class="row mt-3">

								<div class="col-md-6">
									<div class="form-group"><?php esc_html_e( "Guests can't check in on", 'geodir-booking' ); ?></div>
									<div v-for="(day, index) in days" class="custom-control custom-checkbox form-group">
										<input type="checkbox" v-model="listing.ruleset.restricted_check_in_days" :value="index" class="custom-control-input" :id="'gdbc-ruleset-restricted-check-in-days' + index">
										<label class="custom-control-label" :for="'gdbc-ruleset-restricted-check-in-days' + index"><small>{{ day }}</small></label>
									</div>
								</div>

								<div class="col-md-6">
									<div class="form-group"><?php esc_html_e( "Guests can't check out on", 'geodir-booking' ); ?></div>
									<div v-for="(day, index) in days" class="custom-control custom-checkbox form-group">
										<input type="checkbox" v-model="listing.ruleset.restricted_check_out_days" :value="index" class="custom-control-input" :id="'gdbc-ruleset-restricted-check-out-days' + index">
										<label class="custom-control-label" :for="'gdbc-ruleset-restricted-check-out-days' + index"><small>{{ day }}</small></label>
									</div>
								</div>
							</div>
                ...
                <div class="card">
					<div class="card-header bg-white">
						<a href="#" class="collapsed text-dark d-block" data-toggle="collapse" data-target="#gdbc-ruleset-editor-icalendar" aria-expanded="true" aria-controls="gdbc-ruleset-editor-icalendar">
							<?php esc_html_e( 'iCalendar Import / Export', 'geodir-booking' ); ?>
						</a>
					</div>

					<div id="gdbc-ruleset-editor-icalendar" class="collapse" data-parent="#gdbc-ruleset-editor-accordion">
						<div class="card-body">
                            ...
                            <div class="input-group input-group-sm mb-2">
                                ...
                                <div class="input-group-append" style="top: 0px; right: 0px;">
                                    <span role="button" class="input-group-text geodir-booking-ical-copy-url" data-copy-success="<?php esc_attr_e( 'Copied', 'geodir-booking' ); ?>">
                            ...
                            <div class="alert alert-success" role="alert" v-if="listing.ical_sync_status" v-html="listing.ical_sync_status"></div>
			...
			<button type="submit" @click.prevent="saveRuleset(listing.ruleset)" class="btn btn-block btn-primary">
			...
			<button type="submit" @click.prevent="edit_mode = ! edit_mode" class="btn btn-block btn-secondary"><?php esc_html_e( 'Close', 'geodir-booking' ); ?></button>
