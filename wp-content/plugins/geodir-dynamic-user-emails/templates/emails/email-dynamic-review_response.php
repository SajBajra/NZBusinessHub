<?php
/**
 * Review Response Email HTML
 *
 * Email HTML content sent to review owner on publish review.
 *
 * This template can be overridden by copying it to yourtheme/geodirectory/emails/email-dynamic-review_response.php.
 *
