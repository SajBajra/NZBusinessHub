<?php
/**
 * Review Response Email Plain Text
 *
 * Email text content sent to review owner on publish review.
 *
 * This template can be overridden by copying it to yourtheme/geodirectory/emails/plain/email-dynamic-review_response.php.
 *
