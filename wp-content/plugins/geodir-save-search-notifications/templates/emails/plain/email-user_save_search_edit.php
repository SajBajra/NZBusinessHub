<?php
/**
 * Save Search Email Plain Text For Edited Post
 *
 * This template can be overridden by copying it to yourtheme/geodirectory/emails/plain/email-user_save_search.php.
 *
