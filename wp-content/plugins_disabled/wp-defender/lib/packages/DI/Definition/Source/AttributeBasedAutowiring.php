...
use WPMU_DEV\Defender\Vendor\DI\Attribute\Inject;
use WPMU_DEV\Defender\Vendor\DI\Attribute\Injectable;
...
/**
 * Provides WPMU_DEV\Defender\Vendor\DI definitions by reading PHP 8 attributes such as #[Inject] and #[Injectable].
 *
