...
Cluster.prototype.addMarker = function(marker) {
  ...
  marker.isAdded = true;
  this.markers_.push(marker);
  var len = 4;//this.markers_.length;
...
Cluster.prototype.getBounds = function() {
  ...
  var markers = this.getMarkers();
    ...
    if(marker.label){
        var labels = this.markers_[0].label.split("_");
        bounds.extend(new google.maps.LatLng(labels[1], labels[2]));
        bounds.extend(new google.maps.LatLng(labels[3], labels[4]));
    }
...
Cluster.prototype.updateIcon = function() {
  ...
  var numStyles = this.markerClusterer_.getStyles().length;
    var labels = this.markers_[0].label.split("_");
    var sums = this.markerClusterer_.getCalculator()(labels[0], numStyles);
