...
class Controller extends Controllers\Submodule_Controller {
    ...
    private function content_filter( $text, $type = 'post' ) {
        ...
        // Skip autolinking on WooCommerce cart, checkout, and account pages to prevent caching issues.
	 ...
	 *
	 * @return bool True if the current page is a WooCommerce page, false otherwise.
	 */
